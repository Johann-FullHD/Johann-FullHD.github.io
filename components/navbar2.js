      ...
      <header data-thq="thq-navbar" className="navbar2-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar2-desktop-menu">
          <nav className="navbar2-links">
            <Link to="/" className="navbar2-link1 thq-link thq-body-small">
              {props.link1}
            </Link>
            <Link
              to="/informatik"
              className="navbar2-link2 thq-link thq-body-small"
            >
              {props.link2}
            </Link>
            <Link to="/foto" className="navbar2-link3 thq-link thq-body-small">
              {props.link3}
            </Link>
            <Link to="/about" className="navbar2-link4 thq-link thq-body-small">
              {props.link4}
            </Link>
            <Link to="/faq" className="navbar2-link5 thq-link thq-body-small">
              {props.link5}
            </Link>
          </nav>
        </div>
