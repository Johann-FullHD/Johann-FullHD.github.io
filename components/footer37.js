        ...
        <div className="footer37-content">
          ...
          <div className="footer37-social-links">
            <div className="footer37-social-links1">
              ...
              >
                <svg viewBox="0 0 1024 1024" className="footer37-icon">
              ...
              >
                <svg
                  ...
                  className="footer37-icon2 thq-icon-small"
                >
              ...
              >
                <svg viewBox="0 0 1024 1024" className="footer37-icon4">
              ...
              >
                <svg
                  ...
                  className="footer37-icon6 thq-icon-small"
                >
