...
const Footer32 = (props) => {
  return (
    <div className="footer32-footer4 thq-section-padding">
      <div className="footer32-max-width thq-section-max-width">
        <div className="footer32-content">
          <div className="footer32-logo">
            <img
              alt={props.image1Alt}
              src={props.image1Src}
              className="footer32-image1"
            />
          </div>
          <div className="footer32-links">
            ...
            <Link to="/about" className="footer32-link4 thq-body-small">
              {props.link4}
            </Link>
            <Link to="/faq" className="footer32-link5 thq-body-small">
              {props.link5}
            </Link>
          </div>
          <div className="footer32-social-links">
            <div className="footer32-social-links1">
              <a
                href="https://github.com/Johann-FullHD"
                target="_blank"
                rel="noreferrer noopener"
                className="footer32-link"
              >
                <svg viewBox="0 0 1024 1024" className="footer32-icon">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="footer32-link1 thq-body-small footer32-link1"
              >
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="footer32-icon2 thq-icon-small"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="footer32-link2 thq-body-small footer32-link2"
              >
                <svg viewBox="0 0 1024 1024" className="footer32-icon4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="footer32-link3 thq-body-small footer32-link3"
              >
                <svg
                  viewBox="0 0 1024 1024"
                  className="footer32-icon6 thq-icon-small"
                >
        ...
        <div className="footer32-credits">
          ...
          <div className="footer32-row">
            <div className="footer32-footer-links">
              ...
              <Link
                to="/privacy-policy"
                className="footer32-link11 thq-body-small"
              >
                {props.privacyLink}
              </Link>
              <Link
                to="/terms-of-service"
                className="footer32-link12 thq-body-small"
              >
                {props.termsLink}
              </Link>
              <Link
                to="/code-of-conduct"
                className="footer32-link13 thq-body-small"
              >
                {props.codeofconduct}
              </Link>
            </div>
...
Footer32.defaultProps = {
  ...
  link2: 'Informatik',
  image1Src:
    'https://images.unsplash.com/photo-1680065362315-0b0582940c53?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxNTQ0NjgzMXw&ixlib=rb-4.0.3&q=80&w=1080',
